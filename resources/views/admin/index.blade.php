...
SmartPhone Compatible web template, free WebDesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
    ...
    <!-- Bootstrap Core CSS -->
    <link href="/layout/admin/css/bootstrap.css" rel='stylesheet' type='text/css' />

    <!-- Custom CSS -->
    <link href="/layout/admin/css/style.css" rel='stylesheet' type='text/css' />

    <!-- font-awesome icons CSS -->
    <link href="/layout/admin/css/font-awesome.css" rel="stylesheet">
    <!-- //font-awesome icons CSS -->

    <!-- side nav css file -->
    <link href='/layout/admin/css/SidebarNav.min.css' media='all' rel='stylesheet' type='text/css'/>
    <!-- side nav css file -->

    <!-- js-->
    <script src="/layout/admin/js/jquery-1.11.1.min.js"></script>
    <script src="/layout/admin/js/modernizr.custom.js"></script>
    ...
    <!-- Metis Menu -->
    <script src="/layout/admin/js/metisMenu.min.js"></script>
    <script src="/layout/admin/js/custom.js"></script>
    <link href="/layout/admin/css/custom.css" rel="stylesheet">
    <!--//Metis Menu -->
                ...
                <ul class="nofitications-dropdown">
                    <li class="dropdown head-dpdn">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="#">
                                    <div class="user_img"><img src="/layout/admin/images/1.png" alt=""></div>
                            ...
                            <li class="odd"><a href="#">
                                    <div class="user_img"><img src="/layout/admin/images/2.png" alt=""></div>
                                    <div class="notification_desc">
                                        <p>Lorem ipsum dolor amet </p>
                                        <p><span>1 hour ago</span></p>
                                    </div>
                            ...
                            <li><a href="#">
                                    <div class="user_img"><img src="/layout/admin/images/3.png" alt=""></div>
                                    <div class="notification_desc">
                                        <p>Lorem ipsum dolor amet </p>
                                        <p><span>1 hour ago</span></p>
                                    </div>
                    ...
                    <li class="dropdown profile_details_drop">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                            <div class="profile_img">
                                <span class="prfil-img"><img src="/layout/admin/images/2.jpg" alt=""> </span>
                                <div class="user-name">
                                    <p>Admin Name</p>
            ...
            <div class="col-md-4 compose-left">
                ...
                <div class="chat-grid widget-shadow">
                    <ul>
                        ...
                        <li><a href="#">
                                <div class="chat-left">
                                    <img class="img-circle" src="/layout/admin/images/i1.png" alt="">
                        ...
                        <li><a href="#">
                                <div class="chat-left">
                                    <img class="img-circle" src="/layout/admin/images/i2.png" alt="">
                        ...
                        <li><a href="#">
                                <div class="chat-left">
                                    <img class="img-circle" src="/layout/admin/images/i3.png" alt="">
                                    <label class="small-badge bg-green"></label>
                                </div>
                                <div class="chat-right">
                                    <p>Elisa liden </p>
                        ...
                        <li><a href="#">
                                <div class="chat-left">
                                    <img class="img-circle" src="/layout/admin/images/i4.png" alt="">
                                    <label class="small-badge"></label>
                                </div>
                                <div class="chat-right">
                                    <p>Michael John</p>
                ...
                <div class="panel-default">
                    ...
                    <div class="inbox-page">
                        ...
                        <div class="inbox-row widget-shadow" id="accordion" role="tablist" aria-multiselectable="true">
                            ...
                            <div class="mail"><img src="/layout/admin/images/i1.png" alt=""/></div>
                        ...
                        <div class="inbox-row widget-shadow" id="accordion1" role="tablist" aria-multiselectable="true">
                            <div class="mail "> <input type="checkbox" class="checkbox"> </div>
                            <div class="mail"><img src="/layout/admin/images/i2.png" alt=""/></div>
                        ...
                        <div class="inbox-row widget-shadow">
                            <div class="mail "> <input type="checkbox" class="checkbox"> </div>
                            <div class="mail"><img src="/layout/admin/images/i3.png" alt=""/></div>
                        ...
                        <div class="inbox-row widget-shadow">
                            <div class="mail "> <input type="checkbox" class="checkbox"> </div>
                            <div class="mail"><img src="/layout/admin/images/i4.png" alt=""/></div>
...
<!-- side nav js -->
<script src='/layout/admin/js/SidebarNav.min.js' type='text/javascript'></script>
<script>
...
<script src="/layout/admin/js/classie.js"></script>
<script>
...
<!--scrolling js-->
<script src="/layout/admin/js/jquery.nicescroll.js"></script>
<script src="/layout/admin/js/scripts.js"></script>
<!--//scrolling js-->

<!-- Bootstrap Core JavaScript -->
<script src="/layout/admin/js/bootstrap.js"> </script>
